...
tibble::tribble(
  ...
  # var_daily sel
  "prec", "Precipitació (mm)", "Precipitation (mm)", "Precipitación (mm)",
  ...
  "planttrans", "Transpiració", "Plant transpiration (mm)", "Transpiración plantas (mm)",
  "soilevap", "Evaporació del sòl", "Soil evaporation (mm)", "Evaporación del suelo (mm)",
  ...
  "smc", "Contingut hídric del sòl (%)", "Soil moisture content (%)", "Contenido hídrico del suelo (%)",
  "swp", "Potencial hídric del sòl (-MPa)", "Soil water potential (-MPa)", "Potencial hídrico del suelo (-MPa)",
  "stressin", "Intensitat de l'estrès [0-1]", "Stress intensity [0-1]", "Intensidad del estrés [0-1]",
  "stressdur", "Duració de l'estrès (dies)", "Stress duration (days)", "Duración del estrés (días)",
