...
tibble::tribble(
  ...
  'expl_divisions',"Mitjana de la variable a la divisió seleccionada (línea verda) i desviació estàndard (àrea sombrejada de color verd clar)","Mean of the variable in the selected division (green line) and standard deviation (light green shaded area)","Media de la variable en la división seleccionada (línea verde) y desviación estándar (área sombreada de color verde claro)",
  ...
  # "csv_download",'CSV / No Divisió = valors per pixel seleccioant (anual) </br> CSV / Divisió Seleccionada = càlul de (count,sum,mean,stddev,min,max,stderro) per divisio anual','','',
